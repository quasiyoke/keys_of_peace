define('StretchedKeyGenerator', ['crypto-js', 'crypto-js/sha256', 'TooFewIterationsError', 'IncorrectSaltError'], function (CryptoJS, SHA256, TooFewIterationsError, IncorrectSaltError) {
  var StretchedKeyGenerator = function(key){
