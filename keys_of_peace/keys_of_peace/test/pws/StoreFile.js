...
var HmacError = require('../../static/js/pws/HmacError').HmacError;
var IncorrectPasswordError = require('../../static/js/pws/IncorrectPasswordError').IncorrectPasswordError;
var jDataView = require('jdataview');
var sinon = require('sinon');
var StoreFile = require('../../static/js/pws/StoreFile').StoreFile;
var WrongFormatError = require('../../static/js/pws/WrongFormatError').WrongFormatError;
