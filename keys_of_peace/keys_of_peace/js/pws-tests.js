...
function checkPWSStoreWritingHeader(param){
	...
	return checkStoreHeader(store); // This function was defined at checkPWSStoreHeader. This hack allows checking store structure exactly the same way each time.
}
